...
import HeroImage from"C:\Users\krish\Downloads\Portfolio\src\assets\my_profile_2.jpg";
        ...
        <div name="Home" className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800'>
            <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row '>
                <div className='flex flex-col justify-center h-full'>
                    ...
                    I am currently enrolled in the BTech program, CSE, at VIT-AP College. Throughout my academic journey, I have consistently demonstrated my commitment to learning and have achieved 
                    </p>
